...
export function WhatsAppButton() {
  ...
  const phoneNumber = '5547996505700';
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div
        className={`absolute right-full mr-3 top-1/2 -translate-y-1/2 whitespace-nowrap bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg text-sm font-medium transition-all duration-300 ${
